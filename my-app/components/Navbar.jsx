    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
          ...
          <motion.div
            className="hidden md:flex h-12 items-center gap-0.5 bg-[#0a0b85] rounded-full px-2.5 shadow-[0_4px_10px_rgba(0,0,0,0.25)]"
          >
            {navItems.map((item) => (
              <motion.div
                key={item.href}
          ...
          <div className="flex items-center justify-self-end gap-2">
            ...
            >
              <Link
                href="/contact"
                className="group hidden sm:inline-flex h-12 items-center bg-[#0a0b85] text-white hover:bg-[#1e1f92] rounded-full px-8 text-[15px] font-semibold transition-colors shadow-[0_4px_10px_rgba(0,0,0,0.25)]"
              >
