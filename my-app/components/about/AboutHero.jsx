...
export default function AboutHero({ data }) {
  const heroImage = data?.image || '/images/about-hero-bg.jpg';
      ...
      <div className="relative z-10 mx-auto flex min-h-[26.875rem] w-full max-w-[100rem] items-center px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="mt-6 max-w-xl font-semibold text-base leading-relaxed text-[#111827]/88 sm:text-lg text-justify">
              {data.description}
            </p>
          </motion.div>
        </div>
