      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        ...
        <div className="mx-auto mt-9 max-w-5xl space-y-3.5 md:space-y-4">
          {data.milestones.map((milestone, i) => (
            ...
            >
              <div className="relative w-16 shrink-0 md:w-[4.75rem]">
