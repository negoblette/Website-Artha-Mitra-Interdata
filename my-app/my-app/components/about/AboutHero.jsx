...
export default function AboutHero({ data }) {
  return (
    <section className="relative overflow-hidden h-screen min-h-[700px] bg-transparent">
      <div className="absolute inset-0 bg-[#eef1ff]/10" />
      ...
      <div className="relative z-10 mx-auto grid h-full w-full max-w-6xl grid-cols-1 items-center gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_1.15fr] lg:gap-10">
        ...
        <div className="rounded-2xl border border-[#b6c1ff] bg-gradient-to-br from-[#0b2c80] via-[#1f4ca8] to-[#72a3f5] p-1 shadow-[0_18px_44px_rgba(25,45,125,0.2)]">
